...
private:
    void OverrideMaterial(bool ignoreZ, bool flat, bool wireframe, bool glass, const Color& rgba, bool modulate = true, bool gold = false, bool crystal = false, bool crystal2 = false, bool silver = false, bool elixir = false);

    IMaterial* materialRegular = nullptr;
    IMaterial* materialElixir = nullptr;
