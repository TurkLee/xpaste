...
namespace Interfaces
{
	...
	void Initialize()
	{
		...
		g_BaseFileSys = get_interface<i_basefilesystem>(filesysFactory, "VBaseFileSystem011");
		...
		g_FileSystem = **(IFileSystem***)(Utils::PatternScan(engine, "8B 0D ? ? ? ? 83 C1 04 8B 01 FF 37 FF 50 1C 89 47 10") + 2);
