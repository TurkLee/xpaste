...
public:
	...
	{
		static DWORD serverGameDLL = **(DWORD * *)(Utils::PatternScan(GetModuleHandle("engine.dll"), "8B 0D ? ? ? ? 56 57 8B 01 FF 50 28 8B 3D ? ? ? ? 8B F0 68") + 0x2);
	...
	void ModelChangerIndex(int model)
	{
		typedef void(__thiscall* oSetModelIndex)(PVOID, int);
		return CallVFunction< oSetModelIndex >(this, 75)(this, model);
	}
...
{
public:
	NETVAR(bool,tabletReceptionIsBlocked, "CTablet", "m_bTabletReceptionIsBlocked")
...
public:
	...
	{
		static const auto table = reinterpret_cast<uint32_t>(Utils::PatternScan(GetModuleHandle("client.dll"),
	...
	void SetModelIndex(int index)
	{
		CallVFunction<void(__thiscall*)(C_BaseEntity*, int)>(this, 75)(this, index);
	}
	...
	void invalidate_physics_recursive(int32_t flags) {
		static const auto invalidate_physics_recursive = reinterpret_cast<void(__thiscall*)(C_BaseEntity*, int32_t)>(
			Utils::PatternScan(GetModuleHandle("client.dll"), "55 8B EC 83 E4 F8 83 EC 0C 53 8B 5D 08 8B C3 56"));
	...
	Vector GetOrigin()
	{
		static int m_vecOrigin = NetvarSys::Get().GetOffset("DT_BaseEntity", "m_vecOrigin");
	...
	Vector GetVelocity()
	{
		static int m_vecVelocity = NetvarSys::Get().GetOffset("DT_BasePlayer", "m_vecVelocity[0]");
	...
	Vector GetEyeAngles()
	{
		static int m_angEyeAngles = NetvarSys::Get().GetOffset("DT_CSPlayer", "m_angEyeAngles");
