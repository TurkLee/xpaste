...
extern ImFont* AliFont;
extern ImFont* TabFont;

extern ImFont* AimbotFont;
inline ImFont* ExAimbot;
extern IDirect3DTexture9* profil;


inline IDirect3DTexture9* brand_img = nullptr;
inline IDirect3DTexture9* bgbrand_img = nullptr;
inline IDirect3DTexture9* NAHHHH = nullptr;
inline IDirect3DTexture9* rage = nullptr;
inline IDirect3DTexture9* aimbot = nullptr;
inline IDirect3DTexture9* visual = nullptr;
inline IDirect3DTexture9* misc = nullptr;
inline IDirect3DTexture9* env = nullptr;
inline IDirect3DTexture9* settingss = nullptr;
inline IDirect3DTexture9* gamewhite = nullptr;
inline IDirect3DTexture9* gameblack = nullptr;

inline IDirect3DTexture9* profil = nullptr;
inline ImFont* g_pIconFont;

inline IDirect3DTexture9* rageblack = nullptr;
inline IDirect3DTexture9* aimbotblack = nullptr;
inline IDirect3DTexture9* visualblack = nullptr;
inline IDirect3DTexture9* miscblack = nullptr;
inline IDirect3DTexture9* envblack = nullptr;
inline IDirect3DTexture9* settingssblack = nullptr;
