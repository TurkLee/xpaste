...
{
	static auto return_to_fire_bullet = Utils::PatternScan(GetModuleHandle("client.dll"), "8B 0D ? ? ? ? F3 0F 7E 00 8B 40 08 89 45 E4");
	static auto return_to_set_first_person_viewangles = Utils::PatternScan(GetModuleHandle("client.dll"), "8B 5D 0C 8B 08 89 0B 8B 48 04 89 4B 04 B9");
...
{
	static const auto return_to_should_skip_animframe = Utils::PatternScan(GetModuleHandle("client.dll"), "84 C0 75 02 5F C3 8B 0D");
