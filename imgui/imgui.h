...
namespace ImGui
{
   ...
   // IMGUI_API bool   ImageButtonWithText(ImTextureID texId, const char* label, const ImVec2& imageSize, const ImVec2& uv0, const ImVec2& uv1, int frame_padding, const ImVec4& bg_col, const ImVec4& tint_col);
    ...
    void DeadlySeparator(const char* label);
    ...
    IMGUI_API  void CheckMarkxD(ImVec2 pos, ImU32 col, float sz);
	void FlowzerCheckMark(ImVec2 pos, ImU32 col, float sz);
	// <0 frame_padding uses default frame padding settings. 0 for no padding
    IMGUI_API bool          Checkbox(const char* str_id, bool* v);
   // IMGUI_API bool          CheckBox(const char* label, const char* desc, bool* v);
	IMGUI_API void NewCheckbox(const char* str_id, bool* v);
    IMGUI_API bool			ImageButtonWithText(ImTextureID texId, const char* label, const char* desc, const ImVec2& imageSize = ImVec2(0, 0), const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), int frame_padding = -1, const ImVec4& bg_col = ImVec4(0, 0, 0, 0), const ImVec4& tint_col = ImVec4(1, 1, 1, 1));
